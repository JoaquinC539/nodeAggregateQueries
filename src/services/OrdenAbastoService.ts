import { OrdenAbastoModel,OrdenAbasto } from "../class/OrdenAbasto";
import { FacturaModel,Factura } from "../class/Factura";
import { Documento,DocumentoModel } from "../class/Documento";
import { PipelineStage } from "mongoose";


export class OrdenAbastoService{
    constructor(private ordenAbastoModel: typeof OrdenAbastoModel,private facturaModel: typeof FacturaModel){}
    ...
    public buildCuentasCobrarQuery(queryParams:any):Array<PipelineStage>{
        let query:Array<PipelineStage>=[];
        let today:Date=new Date();
        let hasta30:Date=this.substractMonths(today,1);
        let hasta60:Date=this.substractMonths(today,2);
        let hasta90:Date=this.substractMonths(today,3);
    ...
    public substractMonths(date:Date,months:number):Date{
